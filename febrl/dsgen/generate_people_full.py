...
field_list = [givenname_dict, surname_dict, email_dict, streetnumber_dict, address1_dict, organisation_dict,
               suburb_dict, postcode_dict, state_dict,  dob_dict, age_dict, ssid_dict ]
