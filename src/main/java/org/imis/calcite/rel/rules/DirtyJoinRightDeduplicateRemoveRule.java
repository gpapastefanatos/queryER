 ...
 * tablescan.
 */
public class DirtyJoinRightDeduplicateRemoveRule extends RelOptRule {

	public static final DirtyJoinRightDeduplicateRemoveRule INSTANCE =
			new DirtyJoinRightDeduplicateRemoveRule(LogicalDeduplicateJoin.class, 
					Filter.class, Deduplicate.class,
					RelFactories.LOGICAL_BUILDER);
	
	public DirtyJoinRightDeduplicateRemoveRule(Class<? extends LogicalDeduplicateJoin> joinClass,
	...
	public void onMatch(RelOptRuleCall call) {
		...
		newJoin = LogicalDeduplicateJoin.create(join.getLeft(), deduplicateRight.getInput(), join.getCondition(),
				...
				null, rightTableName, null,  deduplicateRight.getFieldTypes().size());	
