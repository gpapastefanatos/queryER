 ...
 */
public class MultiJoinDirtyRightDeduplicateRemoveRule extends RelOptRule{


	public static final MultiJoinDirtyRightDeduplicateRemoveRule INSTANCE =
			new MultiJoinDirtyRightDeduplicateRemoveRule(LogicalDeduplicateJoin.class, 
					LogicalDeduplicateJoin.class, Deduplicate.class,
					RelFactories.LOGICAL_BUILDER);

	/** Creates a ProjectJoinRemoveRule. */
	public MultiJoinDirtyRightDeduplicateRemoveRule(
	...
	protected MultiJoinDirtyRightDeduplicateRemoveRule(RelOptRuleOperand operand,
			RelBuilderFactory relBuilderFactory) {
	...
	public MultiJoinDirtyRightDeduplicateRemoveRule(RelOptRuleOperand operand,
