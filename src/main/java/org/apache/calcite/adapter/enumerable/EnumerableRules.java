...
import org.apache.calcite.adapter.enumerable.EnumerableDeduplicateJoinRule;
import org.imis.calcite.adapter.enumerable.EnumerableDeduplicateRule;
import org.imis.calcite.adapter.enumerable.EnumerableMergeEntitiesRule;
...
public class EnumerableRules {
	...
	public static final EnumerableDeduplicateRule ENUMERABLE_BASELINE_ER_RULE =
			new EnumerableDeduplicateRule();
	
	public static final EnumerableDeduplicateJoinRule ENUMERABLE_JOIN_ER_RULE =
			new EnumerableDeduplicateJoinRule();
	
	public static final EnumerableMergeEntitiesRule ENUMERABLE_MERGE_ENTITIES_RULE =
			new EnumerableMergeEntitiesRule();
	...
	public static final List<RelOptRule> ENUMERABLE_RULES = ImmutableList.of(
			...
			EnumerableRules.ENUMERABLE_BASELINE_ER_RULE,
			EnumerableRules.ENUMERABLE_JOIN_ER_RULE,
			EnumerableRules.ENUMERABLE_MERGE_ENTITIES_RULE,
